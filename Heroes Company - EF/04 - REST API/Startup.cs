...
namespace Matrix
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<MatrixHeroesContext>(Options => Options.UseSqlServer(Configuration.GetConnectionString("MatrixHeroes")));

            services.AddTransient<HeroesLogic>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "_04___REST_API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "_04___REST_API v1"));
            }
